...
Collections must exist within a "namespace," which just means a directory. This project stores collections in the [`ansible_collections/`](../ansible_collections/) path, under the [`my`](../ansible_collections/my/) namespace/directory.
...
```yaml
collections:
  - name: git+https://github.com/redjax/ansible_homelab.git#/ansible_collections/my/homelab,main
...
```yaml
ansible-galaxy collection install -r requirements.yml -p path/to/ansible_collections/dir
```
