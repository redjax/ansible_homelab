...
- `build-my-collections`: The script loops over all collections in [`./ansible_collections/my/](https://github.com/redjax/Ansible/tree/main/ansible_collections/my) and builds each one with `ansible-galaxy collection build`.
